...
@brandes_etal16 discuss the centrality "cube," and interesting an intuitive way to understand the way betweenness centrality works, as well as the dual connection between closeness and betweenness. 
...
The three dimensional array can be thought of as a "cube" by stacking multiple reachability matrices between every pair $s$ and $r$ along a three dimensional dimension $b$. So each "b-slice" of the cube will contain the number of times node $b$ stands in a shortest path between $s$ and $r$.
