...
One neat thing that @blondel_etal04 show is that we can also take a network and compare it to ideal-typical small graphs and get scores for how much that node resembles each of the nodes in the ideal-typical structure. 
