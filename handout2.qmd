...
The "collapse" value in the "mode" argument tells `as.undirected` to take every edge and transform it into an undirected one, collapsing two mutual edges into a single edge and removing the arrows from the one-sided ones. 
