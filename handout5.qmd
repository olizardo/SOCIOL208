...
Which is the ratio of the number of common neighbors divided by the product of the square root of the degrees of each node, since $p$ + $q$ is the degree of node $i$ and $p$ + $r$ is the degree of node $j$.
