...
Which just sums the out and in-distances and takes the square root. Here nodes would be structurally equivalent only if they have the same set of in and out-neighbors. This would mean changing line 11 in the function `d.euclid` above with the following: 
...
## Structuraly Equivalence in Multigraphs
