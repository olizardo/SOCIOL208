...
Recall from the previous handout, that community structure is defined by clusters of nodes that have more connections among themselves than they do with outsiders. If you think about it, a bipartite graph has the exact oppossite of this going on. Nodes of the same type have *zero* connections among themselves, and they have *all* their connections with nodes of the other group!
