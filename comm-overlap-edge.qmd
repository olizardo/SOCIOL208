...
First we load data from an undirected graph, like our trusty *Pulp Fiction* movie network:
...
We can re-construct this network from the list of community memberships for each node like this:
