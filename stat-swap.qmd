...
This is Newman's **assortativity coefficient** (a.k.a., the modularity),  which we covered [here](modularity.qmd), for the nominal category of "Level" telling us that ties are more likely to form between managers of the same level in the company. Is this a "statistically significant" level of assortativity? 
