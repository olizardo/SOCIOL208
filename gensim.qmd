...
We can adapt the approach we used to compute the similarity between nodes in different graphs [here](blondel.qmd) to compute the similarity between nodes in the same graph, or what @blondel_etal04 call the *self-similarity*. 
