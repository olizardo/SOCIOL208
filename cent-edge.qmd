...
We will see that this approach can be used as the basis for an algorithm to find **communities** (clusters of densely connected nodes) in networks in the [lecture notes on community detection](cent-edge.qmd)
