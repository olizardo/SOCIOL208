...
Let us, therefore, begin with the distance approach. Here the goal is simply to pick a distance metric $d$ with a well defined minimum value $d_{min}$, such that:
...
Which are our original clusters of structural equivalent nodes!
