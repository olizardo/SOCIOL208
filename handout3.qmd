...
Everything is like our previous `status1` function except now we are keeping track of two mutually defining scores `a` and `h`. The results for the Krackhardt advice network are:
