...
Where $|E|$ refers to the number of edges in the graph. Note that the numerator of the counts the number of reciprocal links since the product term $a_{ij}a_{ji}$ only when $a_{ij}=1$ *and* $a_{ji}=1$ in the adjacency matrix.
