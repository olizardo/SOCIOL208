...
| Week | Deliverable |
|---|---|
| Week 1 | Data Analysis Exercise I: Basic Network Statistics |
| Week 2 | Data Analysis Exercise II: Centrality |
| Week 3 | Data Analysis Exercise III: Ego Networks |
| Week 4 | Data Analysis Exercise IV: Status and Prestige |
| Week 5 | Data Analysis Exercise V: Role Equivalence and Structural Similarity |
| Week 6 | Data Analysis Exercise VI: Community Structure/Detection; Extended Abstract of Final Project |
| Week 7 | Data Analysis Exercise VII: Advanced Community Detection |
| Week 8 | Data Analysis Exercise VIII: Two-Mode Networks |
| Week 9 | Data Analysis Exercise IX: QAP and Permutation-Based Null Models |
| Week 10 | Data Analysis Exercise X: Exponential Random Graph Models |
| End of Quarter | Final Data Analysis Paper |

Specific calendar dates are TBD and will be announced once the term is scheduled; deliverables are organized by course week rather than fixed dates until then.
