...
Even more interestingly, $\mathbf{L}^+$ is **doubly centered**---similar to the **modularity matrix** [considered here](modularity.qmd). That means *both* the rows and column sums of the matrix are equal to the all zeros vector:
