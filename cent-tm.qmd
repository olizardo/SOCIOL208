...
We have already seen how to calculate the simplest measure of centrality in two-mode networks (degree) in the [basic two-mode statistics](basic-tm.qmd) lecture. Here we extend the discussion to the other two of the big three, **closeness** and **betweenness**. As always, we load up the usual *Southern Women* (SW) data:
