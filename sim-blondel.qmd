...
@blondel_etal04 describe an approach that can help us make headway on this problem. They use a similar iterative procedure that we saw can be used to compute [prestige scores](prest-eigen.qmd) from directed graphs (like [PageRank](pagerank.qmd) and [HITS](hits.qmd)) but this time to *compute [similarity](gensim.qmd)* scores between *pairs* of nodes *across* graphs. 
