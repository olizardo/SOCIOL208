...
In this handout we will discuss the group of strategies focused on randomizing networks via either edge swapping. [This handout](qap.qmd) covers network regression methods via permutation.
