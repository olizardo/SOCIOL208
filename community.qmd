...
A final approach to community detection with good sociological bona fides relies on **edge betweenness**, a concept we covered on the [lecture notes on betweenness centrality](betcent.qmd). An edge has high betweenness if many other pairs of nodes need to use it to reach one another via shortest paths. 
